...
> ## 重要说明
>
> 1. 使用的前提条件：你现在能正常使用immich的机器学习检索照片
> 2. 工作原理：直连 immich的数据库与Immich机器学习服务，实现以图搜图（CLIP）、人脸多目标检索与 1:1 特征比对。
> 3. 使用方式： 可作为独立网页使用也可以内嵌到immich的网页当中
> 4. 开发环境：以immich 3.2.2为开发基础
